...
interface PoolBase {
    ...
    _exactTokenInForTokenOut: (poolPairData: PoolPairBase, amount: BigNumber, exact: boolean) => BigNumber;
    _tokenInForExactTokenOut: (poolPairData: PoolPairBase, amount: BigNumber, exact: boolean) => BigNumber;
...
declare function BPTForTokensZeroPriceImpact(allBalances: BigNumber[], decimals: number[], amounts: BigNumber[], // This has to have the same lenght as allBalances
bptTotalSupply: BigNumber, amp: BigNumber): BigNumber;

export { NewPath, NoNullableField, PoolBase, PoolDictionary, PoolFilter, PoolPairBase, PoolPairDictionary, PoolTypes, SOR, SubgraphPoolBase, SubgraphToken, Swap, SwapInfo, SwapOptions, SwapPairType, SwapTypes, SwapV2, WeightedPool, bnum, scale, BPTForTokensZeroPriceImpact as stableBPTForTokensZeroPriceImpact, BPTForTokensZeroPriceImpact$1 as weightedBPTForTokensZeroPriceImpact };
